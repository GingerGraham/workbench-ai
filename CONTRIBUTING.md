# Contributing to workbench-ai

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add ai`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-ai.git
cd workbench-ai
...
wb dev ai
# — or directly:
wb track ai --branch <your-branch>
```
